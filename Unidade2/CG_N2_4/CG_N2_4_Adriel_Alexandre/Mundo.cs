...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      pontosControle = new List<Ponto4D>
{
    new Ponto4D(-0.5, -0.5),  // Ponto de controle 1
    new Ponto4D(-0.5, 0.5),  // Ponto de controle 2
    new Ponto4D(0.5, 0.5),   // Ponto de controle 3
    new Ponto4D(0.5, -0.5)    // Ponto de controle 4
};

      // Definir o número de linhas que você deseja na spline
      int numLinhas = 10; // Altere conforme necessário

      // Instanciar a Spline
      char rotuloAtual = 'A'; // Exemplo de rótulo
      spline = new Spline(mundo, ref rotuloAtual, pontosControle, numLinhas);
      spline.ShaderObjeto = _shaderAmarelo; // Atribuir o shader


      // Adicionar a spline à lista do grafo
      grafoLista.Add(rotuloAtual, spline);
    ...
    protected override void OnUnload()
    {
      ...
      GL.DeleteProgram(_shaderAmarelo.Handle);
