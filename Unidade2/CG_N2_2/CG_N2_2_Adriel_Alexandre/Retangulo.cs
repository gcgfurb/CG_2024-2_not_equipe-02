...
namespace gcgcg
{
    ...
    {
        public Retangulo(Objeto _paiRef, ref char _rotulo, double v) : this(_paiRef, ref _rotulo, new Ponto4D(-0.5, -0.5), new Ponto4D(0.5, 0.5))
        {
        ...
        {
            // Inicializa o retângulo com os pontos adequados.
            ...
            // Configura a primitiva inicial (Points)
