...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      _shaderVioleta = new Shader("Shaders/shader.vert", "Shaders/shaderMagenta.frag");
      #endregion
      ...
      {
        PrimitivaTipo = (PrimitiveType)x,
        ShaderObjeto = _shaderVioleta
      };
      #endregion
    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
      ...
      if (estadoTeclado.IsKeyPressed(Keys.Space))
       ...
       } else
       {
        ...
        objetoSelecionado.PrimitivaTipo = (PrimitiveType)x;
    ...
    protected override void OnUnload()
    {
      ...
      GL.DeleteProgram(_shaderVioleta.Handle);
